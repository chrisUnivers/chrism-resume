...
func TestGetTask(t *testing.T) {
	...
	t.Run("should return te task", func(t *testing.T) {
		req, err := http.NewRequest(http.MethodGet, "/tasks/32", nil)
		if err != nil {
			t.Fatal(err)
		}
		...
		if rr.Code != http.StatusOK {
			t.Error("invalid status code, it should have failed")
		}
	})
}

...
function CreateListing() {
    ...
    const onSubmit = async (e) => {
        ...
        if(geolocationEnabled) {
            const response = await fetch(`https://maps.googleapis.com/maps/api/geocode/json?address=${address}&key=${import.meta.env.REACT_APP_GEOCODE_API_KEY}`)
            ...
            <main>
                <form onSubmit={onSubmit}>
                    ...
                    <div className="formButtons">
                        ...
                        id="type" value="sale" onClick={onMutate}>Sale</button>
                        <button type="button" className={type === "rent" ? "formButtonActive" : "formButton"}
                        id="type" value="rent" onClick={onMutate}>Rent</button>
                    </div>
